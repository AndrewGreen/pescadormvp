...
public class SessionImpl implements Session, PlaceChangeEvent.Handler {
	...
	private PescadorMVPLocale fallbackLocale;
	...
	private static String FALLBACK_LOCALE_STRING = "es";
	...
	@Override
	public PescadorMVPLocale fallbackLocale() {
		if ((fallbackLocale == null) ||
				(!fallbackLocale.getLocaleName().equals(FALLBACK_LOCALE_STRING)))
			fallbackLocale = setupLocale(FALLBACK_LOCALE_STRING);
	...
	@Override
	public void setSessionData(Class<? extends Component<?>> component, SessionData data) {
